...
metaInfo = dicominfo(fullfile(folder, files(i).name)); % get all of the parameters and info related to the dicom image

% get the slope and intercept to convert to housfield units
slope = metaInfo.RescaleSlope;
intercept = metaInfo.RescaleIntercept;
